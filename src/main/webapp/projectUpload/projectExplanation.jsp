...
<!-- TinyMCE 최신 버전 CDN -->
<script
	src="https://cdn.tiny.cloud/1/dck0qzskpsmvviydjvl1mlker1t6lfq7y6zhyjyjvqe68b24/tinymce/6/tinymce.min.js"
...
tinymce.init({
	...
	';
										...
										if (editor0Content) {
											tinymce.get('editor0').setContent(
													editor0Content);
										} else {
											tinymce
													.get('editor0')
													.setContent(
															"막연하다면 아래의 질문에 대한 답에 내용에 포함되도록 작성해보세요.<br><br>Q. 무엇을 만들기 위한 프로젝트인가요?<br>Q. 프로젝트를 간단히 소개한다면?<br>Q. 이 프로젝트가 왜 의미있나요?<br>Q. 이 프로젝트를 시작하게 된 배경이 무엇인가요?");
										}
										...
										if (editor1Content) {
											...
											tinymce
													.get('editor1')
													.setContent(
															"설정하신 목표 금액을 어디에 사용 예정이신지 구체적인 지출 항목으로 적어 주세요.<br>(예시)<br>목표 금액은 아래의 지출 항목으로 사용할 예정입니다.<br>- 인건비<br>- 배송비<br>- 발주비<br>- 디자인 의뢰비<br>- 수수료");
										}
										...
										if (editor2Content) {
											...
											tinymce
													.get('editor2')
													.setContent(
															"목표 금액을 어디에 사용 예정이신지 구체적인 지출 항목으로 적어 주세요.<br>(예시)<br>목표 금액은 아래의 지출 항목으로 사용할 예정입니다.<br>- 0월 0일: 제품 시안 및 샘플 제작<br>- 0월 0일: 펀딩 시작일<br>- 0월 0일: 펀딩 종료일<br>- 0월 0일: 선물 발송 예정일");
										}
	...
	<form id="projectForm" action="" method="post">
		...
		<div class="container">
			...
			<button class="next-button"
				onclick="submitForm('projectCreatorinfo.jsp')">확인</button>
		</div>
	</form>
